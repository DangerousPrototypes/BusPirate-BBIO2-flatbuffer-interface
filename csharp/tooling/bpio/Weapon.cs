...
public struct Weapon : IFlatbufferObject
{
  ...
  public static Offset<bpio.Weapon> CreateWeapon(FlatBufferBuilder builder,
  ...
  public static Offset<bpio.Weapon> EndWeapon(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<bpio.Weapon>(o);
  }
}
