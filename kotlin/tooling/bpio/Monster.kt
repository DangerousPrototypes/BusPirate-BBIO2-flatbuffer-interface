...
class Monster : Table() {
    ...
    val pos : bpio.Vec3? get() = pos(bpio.Vec3())
    fun pos(obj: bpio.Vec3) : bpio.Vec3? {
        val o = __offset(4)
        return if (o != 0) {
    ...
    fun weapons(j: Int) : bpio.Weapon? = weapons(bpio.Weapon(), j)
    fun weapons(obj: bpio.Weapon, j: Int) : bpio.Weapon? {
        val o = __offset(18)
        return if (o != 0) {
    ...
    fun path(j: Int) : bpio.Vec3? = path(bpio.Vec3(), j)
    fun path(obj: bpio.Vec3, j: Int) : bpio.Vec3? {
        val o = __offset(24)
        return if (o != 0) {
