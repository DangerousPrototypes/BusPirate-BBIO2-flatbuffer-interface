...
public final class Monster extends Table {
  ...
  public bpio.Vec3 pos() { return pos(new bpio.Vec3()); }
  public bpio.Vec3 pos(bpio.Vec3 obj) { int o = __offset(4); return o != 0 ? obj.__assign(o + bb_pos, bb) : null; }
  ...
  public bpio.Weapon weapons(int j) { return weapons(new bpio.Weapon(), j); }
  public bpio.Weapon weapons(bpio.Weapon obj, int j) { int o = __offset(18); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int weaponsLength() { int o = __offset(18); return o != 0 ? __vector_len(o) : 0; }
  public bpio.Weapon.Vector weaponsVector() { return weaponsVector(new bpio.Weapon.Vector()); }
  public bpio.Weapon.Vector weaponsVector(bpio.Weapon.Vector obj) { int o = __offset(18); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  ...
  public bpio.Vec3 path(int j) { return path(new bpio.Vec3(), j); }
  public bpio.Vec3 path(bpio.Vec3 obj, int j) { int o = __offset(24); return o != 0 ? obj.__assign(__vector(o) + j * 12, bb) : null; }
  public int pathLength() { int o = __offset(24); return o != 0 ? __vector_len(o) : 0; }
  public bpio.Vec3.Vector pathVector() { return pathVector(new bpio.Vec3.Vector()); }
  public bpio.Vec3.Vector pathVector(bpio.Vec3.Vector obj) { int o = __offset(24); return o != 0 ? obj.__assign(__vector(o), 12, bb) : null; }
