...
public final class ConfigurationRequest extends Table {
  ...
  public long pullxConfig() { int o = __offset(24); return o != 0 ? (long)bb.getInt(o + bb_pos) & 0xFFFFFFFFL : 0L; }
  public int ioDirectionMask() { int o = __offset(26); return o != 0 ? bb.get(o + bb_pos) & 0xFF : 0; }
  public int ioDirection() { int o = __offset(28); return o != 0 ? bb.get(o + bb_pos) & 0xFF : 0; }
  public int ioValueMask() { int o = __offset(30); return o != 0 ? bb.get(o + bb_pos) & 0xFF : 0; }
  public int ioValue() { int o = __offset(32); return o != 0 ? bb.get(o + bb_pos) & 0xFF : 0; }
  public boolean ledResume() { int o = __offset(34); return o != 0 ? 0!=bb.get(o + bb_pos) : false; }
  public long ledColor(int j) { int o = __offset(36); return o != 0 ? (long)bb.getInt(__vector(o) + j * 4) & 0xFFFFFFFFL : 0; }
  public int ledColorLength() { int o = __offset(36); return o != 0 ? __vector_len(o) : 0; }
  public IntVector ledColorVector() { return ledColorVector(new IntVector()); }
  public IntVector ledColorVector(IntVector obj) { int o = __offset(36); return o != 0 ? obj.__assign(__vector(o), bb) : null; }
  public ByteBuffer ledColorAsByteBuffer() { return __vector_as_bytebuffer(36, 4); }
  public ByteBuffer ledColorInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 36, 4); }
  public String printString() { int o = __offset(38); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer printStringAsByteBuffer() { return __vector_as_bytebuffer(38, 1); }
  public ByteBuffer printStringInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 38, 1); }
  public boolean hardwareBootloader() { int o = __offset(40); return o != 0 ? 0!=bb.get(o + bb_pos) : false; }
  public boolean hardwareReset() { int o = __offset(42); return o != 0 ? 0!=bb.get(o + bb_pos) : false; }
  ...
  public static int createConfigurationRequest(FlatBufferBuilder builder,
    ...
    ConfigurationRequest.addPullxConfig(builder, pullxConfig);
  ...
  public static void addPullxConfig(FlatBufferBuilder builder, long pullxConfig) { builder.addInt(10, (int) pullxConfig, (int) 0L); }
  public static void addIoDirectionMask(FlatBufferBuilder builder, int ioDirectionMask) { builder.addByte(11, (byte) ioDirectionMask, (byte) 0); }
  public static void addIoDirection(FlatBufferBuilder builder, int ioDirection) { builder.addByte(12, (byte) ioDirection, (byte) 0); }
  public static void addIoValueMask(FlatBufferBuilder builder, int ioValueMask) { builder.addByte(13, (byte) ioValueMask, (byte) 0); }
  public static void addIoValue(FlatBufferBuilder builder, int ioValue) { builder.addByte(14, (byte) ioValue, (byte) 0); }
  public static void addLedResume(FlatBufferBuilder builder, boolean ledResume) { builder.addBoolean(15, ledResume, false); }
  public static void addLedColor(FlatBufferBuilder builder, int ledColorOffset) { builder.addOffset(16, ledColorOffset, 0); }
  ...
  public static void addPrintString(FlatBufferBuilder builder, int printStringOffset) { builder.addOffset(17, printStringOffset, 0); }
  public static void addHardwareBootloader(FlatBufferBuilder builder, boolean hardwareBootloader) { builder.addBoolean(18, hardwareBootloader, false); }
  public static void addHardwareReset(FlatBufferBuilder builder, boolean hardwareReset) { builder.addBoolean(19, hardwareReset, false); }
