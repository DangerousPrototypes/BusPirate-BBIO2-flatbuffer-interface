...
public final class RequestPacket extends Table {
  ...
  public int versionMinor() { int o = __offset(6); return o != 0 ? bb.get(o + bb_pos) & 0xFF : 1; }
  ...
  public static void addVersionMinor(FlatBufferBuilder builder, int versionMinor) { builder.addByte(1, (byte) versionMinor, (byte) 1); }
