...
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
pub const ENUM_MAX_REQUEST_PACKET_CONTENTS: u8 = 4;
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
#[allow(non_camel_case_types)]
pub const ENUM_VALUES_REQUEST_PACKET_CONTENTS: [RequestPacketContents; 5] = [
  RequestPacketContents::NONE,
  RequestPacketContents::Monster,
...
impl RequestPacketContents {
  ...
  pub const StatusRequest: Self = Self(2);
  pub const ConfigurationRequest: Self = Self(3);
  pub const DataRequest: Self = Self(4);
...
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
pub const ENUM_MAX_RESPONSE_PACKET_CONTENTS: u8 = 5;
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
#[allow(non_camel_case_types)]
pub const ENUM_VALUES_RESPONSE_PACKET_CONTENTS: [ResponsePacketContents; 6] = [
  ResponsePacketContents::NONE,
  ResponsePacketContents::ErrorResponse,
  ResponsePacketContents::Monster,
...
impl ResponsePacketContents {
  ...
  pub const StatusResponse: Self = Self(4);
  pub const DataResponse: Self = Self(5);
...
impl<'a> RequestPacket<'a> {
  ...
  #[inline]
  #[allow(non_snake_case)]
  pub fn contents_as_monster(&self) -> Option<Monster<'a>> {
    if self.contents_type() == RequestPacketContents::Monster {
      self.contents().map(|t| {
       // Safety:
       // Created from a valid Table for this object
       // Which contains a valid union in this slot
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_union::<RequestPacketContents, _>("contents_type", Self::VT_CONTENTS_TYPE, "contents", Self::VT_CONTENTS, false, |key, v, pos| {
        match key {
          RequestPacketContents::Monster => v.verify_union_variant::<flatbuffers::ForwardsUOffset<Monster>>("RequestPacketContents::Monster", pos),
  ...
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    let mut ds = f.debug_struct("RequestPacket");
      ...
      match self.contents_type() {
        RequestPacketContents::Monster => {
          if let Some(x) = self.contents_as_monster() {
            ds.field("contents", &x)
          } else {
...
impl<'a> ResponsePacket<'a> {
  ...
  #[allow(non_snake_case)]
  pub fn contents_as_monster(&self) -> Option<Monster<'a>> {
    if self.contents_type() == ResponsePacketContents::Monster {
      self.contents().map(|t| {
       // Safety:
       // Created from a valid Table for this object
       // Which contains a valid union in this slot
    ...
    v.visit_table(pos)?
     ...
     .visit_union::<ResponsePacketContents, _>("contents_type", Self::VT_CONTENTS_TYPE, "contents", Self::VT_CONTENTS, false, |key, v, pos| {
        match key {
          ...
          ResponsePacketContents::Monster => v.verify_union_variant::<flatbuffers::ForwardsUOffset<Monster>>("ResponsePacketContents::Monster", pos),
